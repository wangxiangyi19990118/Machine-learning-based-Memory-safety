...
def predict():
    sys.stdout = Logger("predict.log", sys.stdout)
    sys.stderr = Logger("predict.log_file", sys.stderr)  # redirect std err, if necessary

    train_record_file='train256.tfrecords'
    val_record_file='val256.tfrecords'
